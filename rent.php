        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              ...
              <span class="color-text-a">For rent</span>
            </div>
          </div>
    ...
    <section class="property-grid grid">
      <div class="container">
        <div class="row">
          ...
          <?php
            $property = $conn->query("select * from property_table where type = 'rent'");
                            ...
                            <div class="card-footer-a p-0" style="height: 100px;">
                              ...
                              <ul class="card-info d-flex justify-content-around">
                                <li>
                                  ...
                                  <center>
                                  <button class="btn btn-sm btn-outline-light rent" id="<?= $row['id'] ?>"><a href="" class="">Rent now</a></button>
                                  </center>
                                </li>
