    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-6 shadow" id="login"  style="margin-top: 10%; border-radius: 15px; padding: 20px;">
                    <h5 class="text-center"><b>Enter your login Details here</b></h5>
                    <?php
                    ...
                    <form action="./backend/clientLogin.php"  class="form mt-3" method="post">
